...
const move_helper_1 = __webpack_require__(/*! ./helpers/move-helper */ "./build-tsc/helpers/move-helper.js");
const canvas_helpers_1 = __webpack_require__(/*! ./helpers/canvas-helpers */ "./build-tsc/helpers/canvas-helpers.js");
class GameBoard {
    get isGameOver() {
    ...
    constructor(canvasElement, size, initialBoard) {
        this.gameOver = false;
        ...
        this.moveCount = 0;
        this.canvasHelper = new canvas_helpers_1.CanvasHelpers(canvasElement.getContext('2d'));
    ...
    listenForSwipeEvents(canvasElement) {
    ...
    makeMove(direction) {
        ...
        if (direction === this.Directions.LEFT) {
            this.updateBoardFromValues(move_helper_1.MoveHelper.moveLeft(this.valueMatrix));
        }
        else if (direction === this.Directions.RIGHT) {
            this.updateBoardFromValues(move_helper_1.MoveHelper.moveRight(this.valueMatrix));
        }
        else if (direction === this.Directions.UP) {
            this.updateBoardFromValues(move_helper_1.MoveHelper.moveUp(this.valueMatrix));
        }
        else if (direction === this.Directions.DOWN) {
            this.updateBoardFromValues(move_helper_1.MoveHelper.moveDown(this.valueMatrix));
        }
        const emptyCells = this.getAllEmptyCells();
        if (emptyCells.length === 0) {
            if (!move_helper_1.MoveHelper.movesPossible(this.valueMatrix)) {
                this.gameOver = true;
...
/***/ "./build-tsc/helpers/canvas-helpers.js":
/*!*********************************************!*\
  !*** ./build-tsc/helpers/canvas-helpers.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CanvasHelpers = void 0;
const tile_styles_1 = __webpack_require__(/*! ../tile-styles */ "./build-tsc/tile-styles.js");
...
class CanvasHelpers {
    ...
    drawBoard(board, startX = 0, startY = 0) {
        this.begin.x = startX;
        this.begin.y = startY;
    ...
    drawRoundedSquare(posX, posY, sideLength, radius, fillStyle, strokeStyle) {
        return this.drawRoundedRectangle(posX, posY, sideLength, sideLength, radius, fillStyle, strokeStyle);
    }
    drawRoundedRectangle(posX, posY, width, height, radius, fillStyle, strokeStyle) {
    ...
    updateCellValue(boardCell, isGameOver = false) {
    ...
    drawCellValue(value, boardCell, fontColor) {
    ...
    calculateWrapperLength(gridSize) {
        return gridSize * (DEFAULTS.SQUARE_SIDE_LENGTH + DEFAULTS.CELL_PADDING) + DEFAULTS.CELL_PADDING;
    }
    getFontSizeForValue(value) {
        const digitCount = `${value}`.length;
        return DEFAULTS.FONT_SIZE - ((digitCount - 1) * 2.5);
    }
    getBackgroundColor(value) {
        var _a;
        return ((_a = tile_styles_1.TILE_STYLES[`${value}`]) === null || _a === void 0 ? void 0 : _a.background) || '';
    }
    getTextColor(value) {
        var _a;
        return ((_a = tile_styles_1.TILE_STYLES[`${value}`]) === null || _a === void 0 ? void 0 : _a.color) || '';
    }
    setShadow(shadowColor, shadowBlur) {
...
exports.CanvasHelpers = CanvasHelpers;
//# sourceMappingURL=canvas-helpers.js.map

/***/ }),

/***/ "./build-tsc/helpers/move-helper.js":
/*!******************************************!*\
  !*** ./build-tsc/helpers/move-helper.js ***!
  \******************************************/
...
class MoveHelper {
    ...
    static getNextNonZeroValue(values, row, col, direction) {
        let r = row + 1;
        let c = col + 1;
        let value = -1;
        if (direction === 'row') {
    ...
    static makeMove(values, direction) {
        for (let i = 0; i < values.length; i++) {
...
//# sourceMappingURL=move-helper.js.map

/***/ }),

/***/ "./build-tsc/tile-styles.js":
/*!**********************************!*\
  !*** ./build-tsc/tile-styles.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TILE_STYLES = void 0;
exports.TILE_STYLES = Object.freeze({
    '0': {
        background: '#9b9289',
        color: ''
    },
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const game_board_1 = __webpack_require__(/*! ./game-board */ "./build-tsc/game-board.js");
window.addEventListener("load", () => {
    ...
    let gameBoard = new game_board_1.GameBoard(canvas, 4);
    gameBoard.debugDump();
});
